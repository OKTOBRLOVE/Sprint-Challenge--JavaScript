...
*/
function dinosuars(name,diet,weight,length,period){
...
zooAnimals.forEach(element => {displayNames.push(
  element.animal_name + " " + element.scientific_name);
});
